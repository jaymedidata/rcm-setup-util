...
public interface Signer {
	 ...
	 * @param requestPath    The path of the request, not including protocol, host
	 *                       or query parameters.
	 ...
	 */
	Map<String, String> generateRequestHeaders(String httpVerb, String requestPath, String requestPayload)
			throws MAuthSigningException;
}
